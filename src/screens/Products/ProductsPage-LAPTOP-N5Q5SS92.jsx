                            ...
                            <div className="p-6">
                                ...
                                <div className="flex flex-col gap-2 mt-auto">
                                    <button
                                        ...
                                        className="w-full bg-gray-900 hover:bg-black text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors shadow-sm"
                                    >
                                        Buy Now
                                    </button>
                                    <div className="flex gap-2">
                                        {isInCart(product.id) ? (
                                            <button
                                                ...
                                                className="flex-1 flex items-center justify-center gap-2 bg-red-50 border border-red-200 hover:border-red-300 text-red-600 hover:bg-red-100 px-4 py-2 rounded-lg text-sm font-medium transition-all"
                                            >
                                                <Trash2 size={16} />
                                                Remove
                                            </button>
                                            ...
                                            <button
                                                ...
                                                className="flex-1 flex items-center justify-center gap-2 bg-white border border-gray-200 hover:border-gray-300 text-gray-700 hover:bg-gray-50 px-4 py-2 rounded-lg text-sm font-medium transition-all"
                                            >
