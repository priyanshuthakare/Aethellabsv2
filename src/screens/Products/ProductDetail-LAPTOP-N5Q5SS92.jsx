...
import { ArrowLeft, Check, Calendar, CreditCard, ExternalLink, ShoppingCart } from 'lucide-react';
                            ...
                            <div className="flex gap-4">
                                {!isInCart && (
                                    <button
                                        ...
                                        title="Add to Cart"
                                        className="flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-900 px-6 py-4 rounded-xl text-base font-bold transition-all transform active:scale-95 border border-gray-200"
                                    >
                                ...
                                <button
                                    onClick={handleSetup}
                                    className="flex-1 flex items-center justify-center gap-2 bg-white border-2 border-gray-200 hover:border-aethel-500 text-gray-700 hover:text-aethel-600 px-8 py-4 rounded-xl text-base font-bold transition-all transform active:scale-95"
                                >
                                    <Calendar className="w-5 h-5" />
                                    Expert Setup
                                </button>
                            </div>
                            <p className="col-span-1 sm:col-span-2 text-xs text-center text-gray-500 mt-2">
